...
In January, we can see that the average max temperature in each station across the years is oscillating. In July, the average max temperature in each station across the years is quite stable. Therefore, we cannot conclude that the temperature is warming across years or global warming. There are many outliers in the graph such as around January 1982, and July 1988.
